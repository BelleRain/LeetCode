 ...
 * 而”海量日志”就是一种比较典型的日志使用问题——大量打印相同或相似的内容，将有效日志淹没，
 * 还可能降低系统运行效率。因此，需要“海量日志”抑制机制，避免系统运行时产生“海量日志”问题。
 * 海量日志”定义: 10ms内(<10ms)打印2条相同日志 (包含第2条均需要被抑制)，
 * 即:仅保留第一条或100ms内(<100ms)打印10条相似日志(去除字后完全相同的两条日志认为是“相似”，包含第10条均需要被抑制)，
 * 即:仅保留前9条。
